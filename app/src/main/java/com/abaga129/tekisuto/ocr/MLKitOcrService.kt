...
/**
 * Implementation of OcrService using Google's ML Kit
 */
class MLKitOcrService(private val context: Context) : OcrService, CoroutineScope {
    ...
    init {
        ...
        Log.d(TAG, "Initialized MLKit OCR with language: $language")
    ...
    private fun createRecognizerForLanguage(language: String): TextRecognizer {
        return when (language) {
            ...
            // All Latin-based languages use the same TextRecognizerOptions.DEFAULT_OPTIONS
